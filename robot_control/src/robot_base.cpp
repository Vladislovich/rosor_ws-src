...
void controlLoop(RobotHardwareInterface& hardware, controller_manager::ControllerManager& cm, time_source::time_point& last_time) {
...
int main(int argc, char** argv) {
	...
	RobotHardwareInterface hardware(node, private_node, max_wheel_angular_speed);
	...
	ros::TimerOptions control_timer(
		...
		boost::bind(controlLoop, std::ref(hardware), std::ref(cm), std::ref(last_time)), &robot_queue);
